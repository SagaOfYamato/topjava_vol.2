...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.FILTER, query = "SELECT m FROM Meal m WHERE m.user.id=:userId  AND m.dateTime >= :startDateTime " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String FILTER = "Meal.getFiltered";
