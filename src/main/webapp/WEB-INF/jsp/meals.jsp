...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <form method="get" action="profile/meals/get-between">
            <div class="form-row">
                <div class="form-group col-md-2">
                    <label for="inputStartDate"><spring:message code="meal.startDate"/></label>
                    <input type="date" class="form-control" id="inputStartDate" name="startDate">
                </div>
                <div class="form-group col-md-2">
                    <label for="inputEndDate"><spring:message code="meal.endDate"/></label>
                    <input type="date" class="form-control" id="inputEndDate" name="endDate">
                </div>
                <div class="form-group col-md-3">
                    <label for="inputStartTime"><spring:message code="meal.startTime"/></label>
                    <input type="time" class="form-control" id="inputStartTime" name="startTime">
                </div>
                <div class="form-group col-md-3">
                    <label for="inputEndTime"><spring:message code="meal.endTime"/></label>
                    <input type="time" class="form-control" id="inputEndTime" name="endTime">
                </div>
            </div>
            <button class="btn btn-primary" onclick="filterMeal(event)">
        ...
        <table class="table table-striped" id="datatable-meals">
            ...
            <c:forEach items="${requestScope.meals}" var="meal">
                ...
                <tr id="${meal.id}" data-meal-excess="${meal.excess}">
                    <fmt:parseDate  value="${meal.dateTime}"  type="date" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDateTime" />
                    <fmt:formatDate value="${parsedDateTime}" type="both" pattern="yyyy-MM-dd HH:mm" var="mealDateTime" />
                    <td>${mealDateTime}</td>
