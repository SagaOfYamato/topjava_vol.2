...
@org.springframework.test.annotation.ProfileValueSourceConfiguration(ru.javawebinar.topjava.service.ProfileValueSourceConfiguration.class)
public class MealServiceTest extends BaseServiceTest{
    ...
    public void getMealWithUser() {
        ...
        Meal expected = getWithUser();
        MEAL_WITH_USER_MATCHER.assertMatch(actual, expected);
    }
}