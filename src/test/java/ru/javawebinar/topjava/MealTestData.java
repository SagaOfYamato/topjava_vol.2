...
public class MealTestData {
    ...
    public static final MatcherFactory.Matcher<Meal> MEAL_WITH_USER_MATCHER = MatcherFactory.usingIgnoringFieldsComparator("user.registered");
    ...
    public static Meal getWithUser() {
        UserTestData.admin.setMeals(mealsOfAdmin);
        for (Meal meal : mealsOfAdmin) {
            meal.setUser(UserTestData.admin);
        }
        return adminMeal1;
    }
